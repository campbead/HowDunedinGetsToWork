...
- [`preprocess_data.Rmd`](preprocess_data.Rmd) processes census data into the scoring data in the Shiny app
- [`submission_description.txt`](submission_description.txt) is the Submission Description text supplied for the competition.
